        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    "КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО писать, показывать или предлагать какой-либо код — "
                    "ни исправленный, ни альтернативный, ни примерный. "
                    "Объясняй ТОЛЬКО словами: что не так, почему, как думать правильно. "
