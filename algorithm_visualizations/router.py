...
def get_visualization(vis_id: UUID, db: Session = Depends(get_db)):
...
def update_visualization(vis_id: UUID, data: schemas.AlgorithmVisualizationUpdate,
                         db: Session = Depends(get_db),
                         current_user: User = Depends(get_current_user)):
...
def delete_visualization(vis_id: UUID, db: Session = Depends(get_db),
                         current_user: User = Depends(get_current_user)):
