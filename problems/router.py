...
def list_problems(
    ...
    topic: str = Query(None, description="Фильтр по теме задачи (массивы, математика, ввод/вывод...)"),
    tag: str = Query(None, description="Фильтр по slug тега"),
    db: Session = Depends(get_db),
):
    return crud.get_all_problems(db, skip, limit, difficulty, difficulty_code, topic, tag)
